...
<%@ page import="cn.edu.cup.system.home.SystemMenuTreeController" %>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        ...
        <div id="show-systemMenu" class="content scaffold-show" role="main">
            ...
            <g:form controller='systemMenuTree' action='deleteMenuItem' id="${systemMenuInstance?.id}" method="DELETE">
                <fieldset class="buttons">
                    <g:remoteLink class="edit" action="editMenuItem" 
                        controller="systemMenuTree"
                        update="[success:'systemMenuEditDiv', failure:'error']" 
                        on404="alert('not found')"
                    id="${systemMenuInstance?.id}">
                        <g:message code="default.button.edit.label" default="Edit"></g:message>
                    </g:remoteLink>
                    <g:actionSubmit class="delete" 
                        action="deleteMenuItem" 
                        controller="systemMenuTree"
                    value="${message(code: 'default.button.delete.label', default: 'DeleteMenuItem')}" 
                    onclick="return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');">
                    </g:actionSubmit>
                    <a href="systemMenuTree/index">确定</a>
                </fieldset>
            </g:form>
        </div>
    </body>
