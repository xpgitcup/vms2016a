                            ...
                            <tbody>
                                <g:each in="${gasComponentPropertyValueInstanceList}" status="i" var="gasComponentPropertyValueInstance">
                                    <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                                        ...
                                        <td><g:link action="show" id="${gasComponentPropertyValueInstance.id}">${fieldValue(bean: gasComponentPropertyValueInstance, field: "gasComponentProperty")}</g:link></td>
                                        
                                        <td>${fieldValue(bean: gasComponentPropertyValueInstance, field: "gasComponent")}</td>
                                        
                                        <td>${fieldValue(bean: gasComponentPropertyValueInstance, field: "value")}</td>
