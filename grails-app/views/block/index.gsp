		...
		<div id="list-block" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="name" title="${message(code: 'block.name.label', default: 'Name')}" />
				...
				<g:each in="${blockInstanceList}" status="i" var="blockInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${blockInstance.id}">${fieldValue(bean: blockInstance, field: "name")}</g:link></td>
